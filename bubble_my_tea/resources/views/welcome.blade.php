<!-- extends('layouts.default') signifie que le modèle de la page welcome.blade.php 
    sera calqué sur le layout layouts/default.blade.php. Si on voulais utiliser le layout du dashboard, on aurait
    remplacé 'layouts.default' par 'layouts.app' -->
@extends('layouts.default')

{{--  Vous avez remarqué que dans le fichier de layout layouts/default.blade.php, on a une ligne : @yield('content').
      En fait, c'est comme si on remplacait la ligne @yield('content') du default.blade.php par tout le code HTML situé entre @section('content')
      et @endsection dans ce fichier--}}
@section('content')
...
<section class="relative bg-lightpink">
    <div class="container flex flex-col-reverse lg:flex-row items-center gap-12  ">
        <div class="hero container max-w-screen-lg mx-auto pb-10">
            <img class="mx-auto " src="resources/views/bande.jpg"/>
        </div>
    </div>
</section>
...
<section class="bg-pink ">
    ...
    <p class="text-center mt-2">Qui sommes nous ?</p><br> Nous sommes une entreprise qui désire partagés les saveurs de l'asie dans des boissons colorés et délicieuses. Notre objectif est que chaque clients qui viennent nous voir obtiennent le bubble tea qui leur convienne !</p>
        
       
        {{-- <p class="text-center mt-2">Comment le prépare t-on ?</p><br><p>Le thé aux perles a, dans les restaurants et les cafés, l'aspect d'un jus ou d'un milk-shake. On y fait infuser le thé dans du lait ou de l'eau en y ajoutant de la poudre parfumée, notamment aux fruits.
            ...
            Pour servir un thé aux perles, on place les billes dans un verre au fond suffisamment large, pour ne pas les entasser et en faciliter l'aspiration avec la paille, juste assez large pour laisser passer les billes.<p> --}}
